...
layout_home = html.Div(style={"width":"100vw", "margin-left":-8, "margin-top":-10}, children=[
	html.Div(style={"height":50, "width":"100%", "background-color":"#F29C04", "display":"flex"}, children=[
		...
		html.Div(style={"margin":{"l":0, "r":0, "t":0, "b":0}, "height":50, "width":"10%", "text-align":"center", "vertical-align":"middle"},children=[
			dcc.Link([html.H3("Cidades")], href="/page-cities", className="bar"),
		]),
		html.Div(style={"margin":{"l":0, "r":0, "t":0, "b":0}, "height":50, "width":"15%", "text-align":"center", "vertical-align":"middle"}, children=[
			html.A([html.H3("Simulação")], href="/page-simulation", className="bar"),
		]),
		html.Div(style={"margin":{"l":0, "r":0, "t":0, "b":0}, "margin-top":-15, "height":50, "width":"15%", "text-align":"center", "vertical-align":"middle"}, children=[
